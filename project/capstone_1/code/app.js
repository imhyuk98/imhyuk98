...
//         const $toggles = document.querySelectorAll('.toggle'); // NodeList 반환
//         const $toggleBtn = document.getElementById('toggle-btn'); // Element 반환

//         // 토글 버튼이 정상적으로 선택되었는지 확인
//         if ($toggleBtn) {
//             $toggleBtn.addEventListener('click', function () {
//                 toggleElements();
//             });
...
app.post('/registerProc', (req, res) => {
    ...
    var sql = `insert into member(user_id,pw,name)
   values(?,?,?)`
